...
export const MANUAL_SECTIONS = [
  {
    ...
    steps: [
      ...
      { action: 'Elige plan o entra directo', detail: 'En /plans puedes elegir un plan o pulsar «Entrar al estudio» (modo demo). Los administradores van directo al estudio.' },
      { action: 'Configura tu podcast (opcional)', detail: 'El asistente /setup pide nombre, logo, cintillos y formato. Puedes saltarlo y configurar después.' },
      { action: 'Abrir el estudio', detail: 'Pulsa «Entrar al estudio» o ve a /studio. Verás la pantalla principal con cámaras y controles.' },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { action: 'No puedo entrar al estudio', detail: 'Tras login, pulsa «Entrar al estudio» en /plans o ve directo a /studio estando logueado.' },
