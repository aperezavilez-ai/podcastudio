export const BACKGROUND_TEMPLATES = [
  ...
  { id: 'broadcast-news', name: 'Broadcast News', category: 'TV', desc: 'Set de noticiero real', chromaRecommended: true, camera: { top: 8, left: 12, width: 76, height: 82 } },
  ...
  { id: 'glam-tv', name: 'Glam TV', category: 'Entretenimiento', desc: 'Set de TV real con luces', chromaRecommended: true, camera: { top: 8, left: 12, width: 76, height: 82 } },
  ...
  { id: 'podcast-dark', name: 'Podcast Pro', category: 'Podcast', desc: 'Estudio real con luces cálidas', chromaRecommended: false, camera: { top: 10, left: 15, width: 70, height: 78 } },
